...
Mevcut bota optimizasyonu için YOLO entegrasyonu yapılarak, crash thread'lerin önüne geçilir ve daha hızlı çalışır bunun yanında eğitilmiş veri setleri kullanılarak bot AI seviyesine çıkarılabilinir. Bot'dan win32ui.error: BitBlt failed hatası alınıyorsa, oyunda ekran yakalama engelli demektir.
